...
const TestimonialsSection = ({ id, bg }) => (
    <Section id={id} bg={bg}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16"><h2 className="text-4xl md:text-5xl font-black text-white">From The Devs</h2><p className="mt-4 text-lg text-gray-400 max-w-2xl mx-auto">Don't just take our word for it. Here's what our Devs are saying.</p></div>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="glass-card p-8"><p className="text-gray-300">"Mavericks empowers you by enhancing your learning path"</p><div className="mt-4 font-bold text-white">- Suganthan Prabhakaran</div></div>
                <div className="glass-card p-8"><p className="text-gray-300">"The assessments panel is more challenging and secure for 2025 standards."</p><div className="mt-4 font-bold text-white">- Shyam Ganesh</div></div>
                <div className="glass-card p-8"><p className="text-gray-300">"Hackathon panel is what you never imagined a AI could pull."</p><div className="mt-4 font-bold text-white">- Ravi Bharathi</div></div>
            </div>
        </div>
    </Section>
);
