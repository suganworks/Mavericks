...
export default function Dashboard() {
    ...
    useEffect(() => {
        const checkUserAndFetchData = async () => {
            ...
            // Record login in user_logins table (optional - don't fail if table doesn't exist)
            try {
                ...
                console.warn("Could not record login (table may not exist):", error);
    ...
    const saveProfileChanges = async () => {
        ...
        // Validate input
        if (!editingData.username || editingData.username.trim() === '') {
        ...
        try {
            const updateData = {
                ...
                full_name: editingData.full_name?.trim() || null
            };
    ...
    const getSkillLevelColor = (level) => {
        ...
        switch (level.toLowerCase()) {
            case 'expert': return 'bg-red-500/30 text-red-200';
            case 'advanced': return 'bg-orange-500/30 text-orange-200';
            case 'intermediate': return 'bg-yellow-500/30 text-yellow-200';
            case 'beginner': return 'bg-blue-500/30 text-blue-200';
    ...
    return (
        <div className="relative h-screen bg-black text-white p-4 sm:p-6 font-sans overflow-x-hidden overflow-y-auto">
                ...
                <main className="max-h-full overflow-y-auto">
                    ...
                    {userData && (
                        ...
                        >
                                    ...
                                    {isEditingProfile ? (
                                        <div className="space-y-3">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full mt-1 px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-blue-500"
                                                />
                                            </div>
                                            <div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {user?.user_metadata?.provider === 'google' && (
                                                <div>
                                                    <p className="text-gray-400 text-sm">Sign-in Method</p>
                            ...
                            {/* Skills Section */}
                            {(() => {
                                let skillsArray = userData.skills;
                                ...
                                // Filter out any null or invalid skills and limit to 5
                                const validSkills = skillsArray.filter(skill => 
                                    skill && typeof skill === 'object' && (skill.name || skill.skill)
                                ).slice(0, 5); // Show only first 5 skills
                                        ...
                                        <h3 className="text-lg font-semibold mb-4 text-purple-300">
                                            ...
                                            {skillsArray.length > 5 && (
                                                <span className="text-sm text-gray-400 ml-2">
                                                    (showing top 5 of {skillsArray.length})
                                                </span>
                                            )}
                                        </h3>
                                        <div className="flex flex-wrap gap-2">
                                            {validSkills.map((skill, index) => {
                                                ...
                                                return (
                                                    <span 
                                                        key={index}
                                                        className={`px-3 py-1 text-sm font-medium rounded-full ${getSkillLevelColor(skillLevel)}`}
                                                    >
    ...
    <div className="mt-12">
        ...
        <div className="relative group">
            ...
            <div 
                ...
                className="flex overflow-x-hidden overflow-y-hidden pb-6 gap-4 scroll-smooth"
            >
                <AnimatePresence>
